...
export class WebcamImage {
    ...
    private readonly _mimeType: string | any = null;
    private _imageAsBase64: string  | any = null;
    private readonly _imageAsDataUrl: string  | any = null;
    private readonly _imageData: ImageData  | any = null;
